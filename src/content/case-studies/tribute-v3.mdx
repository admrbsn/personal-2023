...
import AudienceDashboardThumbRow from '../../components/AudienceDashboardThumbRow.astro'
...
![Tribute audience insights dashboard, Business & Occupation tab with industry index and composition from Dun & Bradstreet.](../../assets/img/tribute-v3-audience-dashboard-4.png)
