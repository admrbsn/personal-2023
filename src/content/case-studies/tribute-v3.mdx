...
![Choose Your Tribute Package pricing modal showing DIY, Concierge with Video Book, and Concierge tiers.](../../assets/img/tribute-v3-pricing.png)
...
Themes became a primary way users expressed intent and emotion.
...
![Tribute v3 vibe coding diagram comparing the old way vs new way with prompt evolution.](../../assets/img/tribute-v3-vibe-coding.png)
...
![Tribute audience insights dashboard, Demographics tab showing gender, children, income, education, age, and summary insights.](../../assets/img/tribute-v3-audience-dashboard-1.png)

A full state-by-state location breakdown with index scores and composition percentages.

![Tribute audience insights dashboard, Location tab with US states index bars, composition percentages, and sessions.](../../assets/img/tribute-v3-audience-dashboard-2.png)
...
![Tribute audience insights dashboard, Business & Occupation tab with industry index and composition from Dun & Bradstreet.](../../assets/img/tribute-v3-audience-dashboard-3.png)
...
![Audience insights access gate: private dashboard with access phrase entry.](../../assets/img/tribute-v3-audience-dashboard-5.png)
...
![Tribute audience insights dashboard, Personas tab with four archetypes and methodology.](../../assets/img/tribute-v3-audience-dashboard-4.png)
...
Tribute V3 wasn't about trends or tools. It was about aligning the platform with what the product had already become—millions of users creating video tributes for retirements, memorials, birthdays, and milestones, with expectations that the experience would match the weight of those moments.
...
V3 set a new baseline for how we work at Tribute going forward. If I were to revisit it, I'd invest earlier in documenting the prompt patterns that worked—we learned them on the fly, and that knowledge lived mostly in my head.
